    ...
    <>
      <div className="dropdown dropdown-bottom p-0 mx-3">
        <div
          tabIndex={0}
          role="button"
          className="btn justify-between max-w-46 normal-case"
        >
        ...
        <ul
          tabIndex={0}
            ref={btn_ref}
          className="dropdown-content menu -left-4 sm:-left-6 sm:menu-lg bg-base-100 rounded-box z-1 sm:w-46 p-2 shadow-md text-neutral"
        >
          {OPTIONS.map((o) => (
            <li key={o.vt}>
              <a
